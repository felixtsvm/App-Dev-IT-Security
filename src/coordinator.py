...
def run_complete_scan(ip_address):
    ...
    Returns:
        dict: Ein Dictionary mit einem 'success'-Statusflag und den jeweiligen Daten- oder Fehlerbereichen.
    """
